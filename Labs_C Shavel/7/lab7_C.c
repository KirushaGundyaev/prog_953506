...
typedef struct student
{
	...
	int course;
	int group;
	int* marks1, * marks2; /*адзнакі за першую і другую сесіі*/
	double average1, average2; /*сярэдні бал за першую і другую сесіі*/

	int ratingPlace1, ratingPlace2; /*месца ў рэйтынгу першай і другой сесіі*/
	double averageDelta; /*рост  адносна апошняй сесіі*/
	int ratingDelta; /*змена месца ў рэйтынгу*/
} Student;
